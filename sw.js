...
var CORE = [
    ...
    "./tools/touch-tester/",
    "./tools/sensor-viewer/",
    "./tools/radix-converter/",
    "./tools/aes-tool/",
    "./tools/cert-decoder/",
    "./tools/json-diff/",
    "./tools/cidr-calculator/",
    "./demos/css-length-unit/",
    "./demos/drag-and-drop/",
    "./demos/presentation/",
    "./demos/elephant-alpha/",
    "./en/tools/timestamp-converter/",
    "./en/tools/json-formatter/",
    "./en/tools/emoji-tool/",
    "./en/tools/mermaid-editor/",
    "./en/tools/url-codec/",
    "./en/tools/base64-converter/",
    "./en/tools/regex-tester/",
    "./en/tools/random-generator/",
    "./en/tools/cron-tool/",
    "./en/tools/color-tool/",
    "./en/tools/text-diff/",
    "./en/tools/hash-tool/",
    ...
    "./en/tools/http-reference/",
    "./en/tools/unicode-inspector/",
    "./en/tools/sql-formatter/",
    "./en/tools/yaml-converter/",
    "./en/tools/curl-parser/",
    "./en/tools/html-entities/",
    "./en/tools/keypair-generator/",
    "./en/tools/markdown-preview/",
    "./en/tools/timezone-planner/",
    "./en/tools/date-calculator/",
    "./en/tools/docker-compose-converter/",
    "./en/tools/rmb-uppercase/",
    "./en/tools/chmod-calculator/",
    "./en/tools/svg-optimizer/",
    "./en/tools/qr-scanner/",
    "./en/tools/exif-viewer/",
    "./en/tools/device-info/",
    "./en/tools/touch-tester/",
    "./en/tools/sensor-viewer/",
    "./en/tools/radix-converter/",
    "./en/tools/aes-tool/",
    "./en/tools/cert-decoder/",
    "./en/tools/json-diff/",
    "./en/tools/cidr-calculator/",
    "./en/demos/css-length-unit/",
    "./en/demos/drag-and-drop/",
    "./en/demos/presentation/",
    "./en/demos/elephant-alpha/",
    /* /gen:core */
];
